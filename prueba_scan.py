...
def main():
    ...
    blocks = [
        # name, start, end, step, grating, filter
        ("B1_0400_0700", 400, 700, 2, 1, 2),
        ("B2_0701_1000", 701, 1000, 2, 2, 3),
        ("B3_1001_1300", 1001, 1300, 2, 2, 4),
        ("B4_1301_1700", 1301, 1700, 2, 2, 5),
    ]
    ...
    try:
        ...
        for (name, s, e, step, g, flt) in blocks:
            run_block(
                mono, cam, out_dir,
                block_name=name,
